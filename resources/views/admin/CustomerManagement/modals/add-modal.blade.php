    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Add Vehicle to <span id="customeri"></span></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form  action="{{url('/anotherVehicle')}}" method="post" novalidate enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="modal-body">

                    <input type="text" name="customer" id="customer" hidden>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('abrand') is-invalid @enderror" placeholder="brand" name="abrand"  value="{{ old('abrand') }}" />
                            @error('abrand')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('amodelName') is-invalid @enderror" placeholder="model name" name="amodelName"  value="{{ old('amodelName') }}" />
                            @error('amodelName')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('ayear') is-invalid @enderror" placeholder="20XX" name="ayear"  value="{{ old('ayear') }}" />
                            @error('ayear')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <select class="form-select @error('atype') is-invalid @enderror" aria-label="Default select example" name="atype" required >
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <select class="form-select @error('aengine') is-invalid @enderror" aria-label="Default select example" name="aengine" required >
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('anumberPlate') is-invalid @enderror" placeholder="CAR-XXXX" name="anumberPlate"  value="{{ old('anumberPlate') }}" />
                            @error('anumberPlate')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
