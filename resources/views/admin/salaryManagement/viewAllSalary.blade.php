            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex justify-content-between  py-3 mb-4">
                        <h4 class="fw-bold"><span class="text-muted fw-light"></span>Salary Management<i class="bi bi-arrow-right"></i>view All History</h4>
                        <a href="{{ url('/salaryManagement') }}" class="btn btn-success" >
                            Back
                            </a>
                    </div>

                    <div class="card">
                        <h5 class="card-header">All Salaries</h5>
