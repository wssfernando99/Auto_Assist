            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex justify-content-between  py-3 mb-4">
                        <h4 class="fw-bold"><span class="text-muted fw-light"></span>Vehicle Management<i class="bi bi-arrow-right"></i> Past Record</h4>
                    ...
                    <div class="card">
                        <h5 class="card-header">Record Sheet</h5>
                        <div class="card-body">
                            <div class="row">
                                {{-- <div class="col-md-12">
